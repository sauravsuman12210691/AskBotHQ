    ...
    return (
        <div className="signUp">
            ...
            <div className="signnn">
                <form className="form">
                    <label for="name" id="Name" className="required">Name</label>
                    <input type="text" name="name" id="name" placeholder="Enter your name" required />
                    <label for="number" id="Number" className="required">Phone Number</label>
                    <input type="number" name="number" id="number" placeholder="Enter your phone number" required maxLength={length} minLength={length} />
                    <label for="email" id="Email" className="required">Email ID</label>
                    ...
                    <input type="password" name="confirmPassword" id="password" required placeholder="Confirm Password" />
